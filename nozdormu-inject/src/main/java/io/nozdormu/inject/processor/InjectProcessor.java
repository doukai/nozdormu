...
public class InjectProcessor extends AbstractProcessor {
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
            ...
            processorManager
                ...
                .ifPresent(
                    componentCompilationUnit -> {
                      compilationUnitListMap.put(
                          typeElement.getQualifiedName().toString(), componentCompilationUnit);
                      buildComponentProxy(typeElement)
                          .ifPresent(
                              compilationUnit -> {
    ...
    List<List<CompilationUnit>> partitions =
        Lists.partition(
            new ArrayList<>(compilationUnitListMap.values()),
            processorManager.getSuppliersPartitionSize());
    partitions.forEach(
        compilationUnitList -> {
          int suffix = SUPPLIER_SEQ.getAndIncrement();
          CompilationUnit proxySuppliersCompilationUnit =
              buildProxySuppliers(
                  rootPackageName, compilationUnitList, proxyCompilationUnitMap, suffix);
  ...
  private void buildObserverInnerClasses(
    ...
    observesMethods.forEach(
        methodDeclaration -> {
          ...
          if (processorManager
              .getQualifiedName(methodDeclaration.getType())
  ...
  private CompilationUnit buildProxySuppliers(
      ...
      List<CompilationUnit> componentCompilationUnitList,
        ...
        new ClassOrInterfaceDeclaration()
            ...
            .addAnnotation(
                new SingleMemberAnnotationExpr()
                    .setMemberValue(new ClassExpr().setType(BeanSuppliers.class))
    ...
    componentCompilationUnitList.forEach(
        componentCompilationUnit ->
            processorManager
                .getPublicClassOrInterfaceDeclaration(componentCompilationUnit)
                .ifPresent(
                    componentClassDeclaration -> {
                      ...
                      //
                      // processorManager.importAllClassOrInterfaceType(suppliersClassDeclaration,
                      // componentClassDeclaration);
                      //
                      ...
                      Expression objectCreateExpression =
                          Optional.ofNullable(proxyCompilationUnitMap.get(qualifiedName))
                              .flatMap(
                                  compilationUnit ->
                                      processorManager.getPublicClassOrInterfaceDeclaration(
                                          compilationUnit))
                              .map(
                                  proxyClassDeclaration ->
                                          ...
                                          .map(
                                              producesMethodDeclaration ->
                                                  (Expression)
                                                      new MethodCallExpr()
                                                          .setName(
                                                              producesMethodDeclaration.getName())
                                                          .setArguments(
                                                              producesMethodDeclaration
                                                                  .getParameters()
                                                                  .stream()
                      ...
                      if (componentClassDeclaration.isAnnotationPresent(Singleton.class)
                          || componentClassDeclaration.isAnnotationPresent(
                        ...
                        holderClassDeclaration
                            .addFieldWithInitializer(
                                qualifiedName, "INSTANCE", objectCreateExpression)
                            .setModifiers(
                            ...
                            new MethodCallExpr()
                                ...
                                .setScope(
                                    new MethodCallExpr()
                                        .setName("get")
                                        .addArgument(
                                            new ClassExpr().setType(ReactorBeanScoped.class))
                                        .addArgument(
                                            new MethodCallExpr()
                                                .setName("of")
                                                .addArgument(
                                                    new StringLiteralExpr(Named.class.getName()))
                                                .addArgument(
                                                    new MethodCallExpr()
                                                        .setName("of")
                          ...
                          .filter(
                              producesMethodDeclaration ->
                                  producesMethodDeclaration.isAnnotationPresent(Singleton.class)
                                      || producesMethodDeclaration.isAnnotationPresent(
                                          ApplicationScoped.class))
                          .forEach(
                              producesMethodDeclaration -> {
                                ...
                                String producesPrefix =
                                    methodTypeQualifiedName.replaceAll("\\.", "_");
                          ...
                          .forEach(
                              annotationExpr -> {
                                if (processorManager.hasMetaAnnotation(
                                  ...
                                  mapOf.addArgument(
                                      qualifierToExpression(
                                          annotationExpr, suppliersCompilationUnit));
                                }
                              });
                            ...
                            new MethodCallExpr()
                                ...
                                .setScope(
                                    new MethodCallExpr()
                                        .setName("computeIfAbsent")
                                        .addArgument(
                                            new StringLiteralExpr(qualifiedName + "_Proxy"))
                                        .addArgument(
                                            new LambdaExpr()
                                                .addParameter(
                                                    new Parameter()
                              ...
                              extendedTypeName ->
                                  staticInitializer.addStatement(
                                      new MethodCallExpr()
                                          ...
                                          .addArgument(new StringLiteralExpr(qualifiedName))
                                          .addArgument(
                                              new NameExpr(componentPrefix + "_beanSupplier"))
                                          .setScope(
                                              new MethodCallExpr()
                                                  .setName("computeIfAbsent")
                                                  .addArgument(
                                      ...
                                      new MethodCallExpr()
                                          ...
                                          .setScope(
                                              new MethodCallExpr()
                                                  .setName("computeIfAbsent")
                                                  .addArgument(
                                                      new StringLiteralExpr(implementedTypeName))
                                                  .addArgument(
                                                      new LambdaExpr()
                                                          .addParameter(
                                                              new Parameter()
                                              ...
                                              new NameExpr(
                                                  producesPrefix
                                                      ...
                                                      + componentClassDeclaration
                                                          .getMethods()
                                                          .indexOf(producesMethodDeclaration)));
                                } else if (producesMethodDeclaration.isAnnotationPresent(
                                        RequestScoped.class)
                                    || producesMethodDeclaration.isAnnotationPresent(
                                        SessionScoped.class)
                                    || producesMethodDeclaration.isAnnotationPresent(
                                      ...
                                      new MethodCallExpr()
                                          .setName(
                                              processorManager
                                                  ...
                                                  : "get")
                                          .addArgument(
                                              new ClassExpr().setType(methodTypeQualifiedName))
                                          .addArgument(
                                              new LambdaExpr()
                                                  .setEnclosingParameters(true)
                                                  .setBody(
                                          ...
                                          .setScope(
                                              new MethodCallExpr()
                                                  ...
                                                  .addArgument(
                                                      new ClassExpr()
                                                          .setType(ReactorBeanScoped.class))
                                                  .addArgument(
                                                      new MethodCallExpr()
                                                          .setName("of")
                                                          .addArgument(
                                                  ...
                                                  .setScope(
                                                      new NameExpr(
                                                          BeanContext.class.getSimpleName())));
                                } else {
                                  producesCreateExpression =
                                      new MethodCallExpr()
                                          .setName(producesMethodDeclaration.getName())
                                    ...
                                    new MethodCallExpr()
                                        ...
                                        .addArgument(
                                            new LambdaExpr()
                                                .setEnclosingParameters(true)
                                                .setBody(
                                                    new ExpressionStmt(producesCreateExpression)))
                                        .setScope(new NameExpr(producesPrefix + "_beanSupplier")));
