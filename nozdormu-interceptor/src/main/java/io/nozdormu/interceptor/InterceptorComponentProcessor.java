...
public class InterceptorComponentProcessor implements ComponentProxyProcessor {
  ...
  public boolean processComponentProxy(
    ...
    List<ConstructorDeclaration> constructorBindings =
    ...
    if (!methodBindings.isEmpty()) {
      buildMethod(componentProxyCompilationUnit, componentProxyClassDeclaration, methodBindings);
    }
    if (!constructorBindings.isEmpty()) {
      buildConstructor(
          componentProxyCompilationUnit, componentProxyClassDeclaration, constructorBindings);
    }
    logger.info(
        "{} interceptor component build success",
        componentClassDeclaration
            .getFullyQualifiedName()
            .orElseGet(componentClassDeclaration::getNameAsString));
    ...
    methodDeclarations.forEach(
        methodDeclaration -> {
          ...
          if (!annotationExprList.isEmpty()) {
                        ...
                        .map(
                            parameter ->
                                parameter.getType().isClassOrInterfaceType()
                                    ? parameter.getType().asClassOrInterfaceType().getNameAsString()
                        ...
                        new VariableDeclarator()
                            .setType(
                                new ClassOrInterfaceType()
                                    .setName("List")
                                    .setTypeArguments(
                                        new ClassOrInterfaceType().setName("InvokeInterceptor")))
            ...
            MethodDeclaration overrideMethodDeclaration =
                componentProxyClassDeclaration
                    .addMethod(methodDeclaration.getNameAsString())
                    .setModifiers(
            ...
            MethodDeclaration proxyMethodDeclaration =
                componentProxyClassDeclaration
                    .addMethod(proxyMethodName)
                    .setModifiers(
                        methodDeclaration.getModifiers().stream()
                            .collect(Collectors.toCollection(NodeList::new)))
                    .addParameter(InvocationContext.class, "invocationContext");

            methodDeclaration.getTypeParameters().forEach(proxyMethodDeclaration::addTypeParameter);

            VariableDeclarationExpr invocationContextProxyVariable =
            ...
            MethodCallExpr superMethodCallExpr =
                new MethodCallExpr()
                      ...
                      new TryStmt()
                          ...
                          .setCatchClauses(
                              NodeList.nodeList(
                                  new CatchClause()
                                      .setParameter(
                                          new Parameter().setType(Exception.class).setName("e"))
                                      .setBody(
                                          new BlockStmt()
                                              .addStatement(
                                                  new ThrowStmt()
            ...
            BlockStmt body =
                overrideMethodDeclaration
                    .getBody()
                    .orElseGet(overrideMethodDeclaration::createBody);

            VariableDeclarator ownerValueMap =
                new VariableDeclarator()
                    .setType(
                        new ClassOrInterfaceType()
                            .setName("Map")
            ...
            IntegerLiteralExpr methodParameterCount =
                new IntegerLiteralExpr(String.valueOf(methodDeclaration.getParameters().size()));
            ArrayCreationExpr methodParameterTypeNames =
    ...
    constructorDeclarations.forEach(
        constructorDeclaration -> {
          ...
          if (!annotationExprList.isEmpty()) {
                        ...
                        new VariableDeclarator()
                            .setType(
                                new ClassOrInterfaceType()
                                    .setName("List")
                                    .setTypeArguments(
                                        new ClassOrInterfaceType().setName("ConstructInterceptor")))
                            .setName(
                                "create"
                                    + componentProxyClassDeclaration.getNameAsString()
                                    + "ConstructInterceptorList")
                            .setInitializer(
                                new MethodCallExpr()
            ...
            MethodDeclaration creatorMethod =
                componentProxyClassDeclaration
                    .addMethod("create" + componentProxyClassDeclaration.getNameAsString())
            ...
            MethodDeclaration invocationCreatorMethod =
                componentProxyClassDeclaration
                    .addMethod("create" + componentProxyClassDeclaration.getNameAsString())
                    .setModifiers(Modifier.Keyword.PUBLIC, Modifier.Keyword.STATIC)
                    .setType(Object.class)
            ...
            ObjectCreationExpr invocationCreatorMethodCallExpr =
                new ObjectCreationExpr()
                    .setType(componentProxyClassDeclaration.getNameAsString())
                    .setArguments(
            ...
            IntegerLiteralExpr constructorParameterCount =
                new IntegerLiteralExpr(
                    String.valueOf(constructorDeclaration.getParameters().size()));
            ArrayCreationExpr constructorParameterTypeNames =
                new ArrayCreationExpr()
                    .setElementType(String.class)
                    .setInitializer(
                        new ArrayInitializerExpr(
            ...
            MethodCallExpr setTarget =
                new MethodCallExpr()
                    .setName("setTarget")
                    .addArgument(
                        new ClassExpr().setType(componentProxyClassDeclaration.getNameAsString()))
                    .setScope(
                        new MethodCallExpr()
                            .setName("getContextProxy")
                            .setScope(new NameExpr("cur")));
