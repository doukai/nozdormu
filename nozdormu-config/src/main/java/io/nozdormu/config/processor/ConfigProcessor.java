...
public class ConfigProcessor extends AbstractProcessor {
  ...
  public boolean process(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
    ...
    CompilationUnit proxySuppliersCompilationUnit =
        buildProxySuppliers(rootPackageName, compilationUnitListMap);
  ...
  private CompilationUnit buildProxySuppliers(
      String rootPackageName, Map<TypeElement, CompilationUnit> compilationUnitListMap) {
    ...
    compilationUnitListMap.forEach(
        (typeElement, configCompilationUnit) ->
            processorManager
                .getPublicClassOrInterfaceDeclaration(configCompilationUnit)
                .ifPresent(
                    configClassDeclaration -> {
                      String qualifiedName =
                          processorManager.getQualifiedName(configClassDeclaration);
                      ...
                      holderClassOrInterfaceDeclaration
                          .addFieldWithInitializer(
                              qualifiedName,
                              "INSTANCE",
                              getConfigMethodCall(qualifiedName, propertyName))
                          .setModifiers(
